...
import { Play, Pause, Globe, MessageSquare, Mail, Phone } from 'lucide-react';
...
interface PitchPageViewerProps {
  data: PitchPageData;
}

export const PitchPageViewer: React.FC<PitchPageViewerProps> = ({ data }) => {
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6 sm:py-8 lg:py-12">
        ...
        {data.contactInfo && (
          <div className="bg-zinc-900 rounded-xl border border-zinc-800 p-6 sm:p-8 text-center">
            ...
            <p className="text-zinc-400 text-sm sm:text-base whitespace-pre-wrap">{data.contactInfo}</p>
          </div>
        )}
      </main>
